...
const styles = `
  ...
  .portfolio-photo {
    filter: saturate(0.72) sepia(0.1) contrast(0.96) brightness(0.98);
  }
`;
...
export default async function PortfolioPage() {
  ...
  return (
    <main className="min-h-screen bg-[var(--paper)] text-[var(--onyx)] overflow-x-auto">
      <style>{`
        ${styles}
  ...
  />
          ...
          <div>
            ...
            <div className="bg-[var(--card)] border border-[var(--stucco)] rounded-xl p-[5mm] h-[118mm]">
              <div
...
function A4Page({ children }: { children: ReactNode }) {
  return (
    <section className="a4-page w-[297mm] h-[210mm] bg-[var(--paper)] p-[9mm] overflow-hidden relative">
      <img
...
function Header() {
  return (
    <header className="flex justify-between items-start border-b border-[var(--stucco)] pb-[5mm]">
      <div>
        <p className="text-[10px] uppercase tracking-[0.45em] text-[var(--walnut)] font-bold">
          Confidential Portfolio Report
        </p>
        <h1 className="text-[34px] leading-none font-bold text-[var(--walnut)] mt-3">
...
function Footer() {
  return (
    <footer className="absolute bottom-[6mm] left-[9mm] right-[9mm] flex justify-between text-[9px] text-[var(--ash)] border-t border-[var(--stucco)] pt-[2mm]">
...
function SectionHeader({
  ...
  return (
    <>
      <p className="text-[10px] uppercase tracking-[0.42em] text-[var(--walnut)] font-bold">
        {number} · {label}
      </p>
...
function MetricCard({
  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--stucco)] rounded-lg p-[4mm] h-[27mm]">
      <p className="text-[7.5px] uppercase tracking-[0.25em] text-[var(--ash)] font-bold leading-tight">
        {label}
      </p>
      <p className={`text-[17px] font-bold mt-2 leading-none ${accent ? "text-[var(--walnut)]" : ""}`}>
        {value}
      </p>
    </div>
  );
...
function CapitalStackCard({
  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--stucco)] rounded-xl p-[5mm]">
      <div className="flex items-start justify-between gap-[5mm]">
      <div>
  <p className="text-[10px] uppercase tracking-[0.25em] text-[var(--walnut)] font-bold">
    Net Equity in Portfolio
  </p>
  <p className="text-[22px] leading-none font-bold text-[var(--walnut)] mt-[2mm]">
    ...
    Expected End Value - Mortgages
      ...
      <div className="mt-[6mm]">
        <div className="flex justify-between text-[10px] font-bold mb-[2mm]">
          <span className="text-[var(--walnut)]">
...
function CapitalMetric({
  ...
  return (
    <div className="bg-[var(--paper)] border border-[var(--stucco)] rounded-lg p-[3mm]">
...
function ChartCard({ title, children }: { title: string; children: ReactNode }) {
  return (
    <div className="bg-[var(--card)] border border-[var(--stucco)] rounded-xl p-[4mm] h-[61mm]">
      ...
      <div className="space-y-1.5">
        {rows.map((row) => (
          <div key={row.label}>
            ...
            <div className="h-[2.5mm] bg-[var(--paper)] rounded-full overflow-hidden">
              <div
...
function ProjectDetailPage({
  ...
  return (
    <>
      <div className="flex justify-between items-end border-b border-[var(--stucco)] pb-[4mm]">
        <div>
          <SectionHeader
            number="04"
            ...
            title={name}
          />
          <p className="text-[11px] text-[var(--walnut)] mt-2">{project.address}</p>
        </div>
      ...
      <div className="grid grid-cols-[1.05fr_0.95fr] gap-[6mm] mt-[5mm]">
        <div>
          {photo ? (
            <img
              src={photo}
              alt={name}
              className="portfolio-photo w-full h-[98mm] object-cover rounded-xl border border-[var(--stucco)]"
            />
          ) : (
            <div className="w-full h-[98mm] rounded-xl bg-[var(--soft)] border border-[var(--stucco)] flex items-center justify-center text-center px-[10mm]">
              <div>
        ...
        <div>
          ...
          <div className="mt-[5mm]">
            <p className="text-[10px] uppercase tracking-[0.28em] text-[var(--walnut)] font-bold mb-[2mm]">
              Value Creation
            </p>
          ...
          <div className="bg-[var(--card)] border border-[var(--stucco)] rounded-xl p-[5mm] mt-[5mm]">
            <p className="text-[9px] uppercase tracking-[0.25em] text-[var(--walnut)] font-bold mb-[4mm]">
              Project Memorandum
            </p>
          ...
          {(hasValue(project.exitstrategy) || hasValue(project.notes)) && (
            <div className="border-t border-[var(--onyx)] mt-[5mm] pt-[3mm] text-[11px] leading-snug">
...
function PipelineCard({ project }: { project: CsvRow }) {
  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--stucco)] rounded-xl overflow-hidden h-[147mm]">
      {hasValue(coverImage) ? (
        <img
          src={coverImage}
          alt={`${name} location`}
      ...
      <div className="p-[5mm]">
        <div className="flex justify-between gap-[5mm]">
          <div>
            ...
            {hasValue(location) && (
              <p className="text-[11px] text-[var(--walnut)] mt-2 leading-snug">{location}</p>
            )}
          </div>

          <span className="h-fit bg-[var(--walnut)] text-white rounded-full px-4 py-2 text-[9px] uppercase font-bold">
            {badgeLabel}
          </span>
        </div>
...
function SoldProjectCard({ project }: { project: CsvRow }) {
  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--stucco)] rounded-xl overflow-hidden h-[147mm]">
      {photo ? (
        <img src={photo} alt={name} className="portfolio-photo w-full h-[53mm] object-cover" />
      ) : (
      ...
      <div className="p-[5mm]">
        ...
        <p className="text-[11px] text-[var(--walnut)] mt-2 leading-snug h-[12mm] overflow-hidden">
          {project.address}
        </p>
        ...
        <div className="bg-[var(--card)] border border-[var(--stucco)] rounded-xl p-[4mm] mt-[5mm]">
          <p className="text-[8px] uppercase tracking-[0.22em] text-[var(--walnut)] font-bold mb-[3mm]">
            Deal Summary
          </p>
...
function StackBar({
  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--stucco)] rounded-xl p-[4mm]">
        ...
        {segments.map((segment) => (
          <div key={segment.label} className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-[12px] font-bold text-[var(--onyx)] mt-1">
                {money(segment.value)}
              </p>
            </div>
          </div>
